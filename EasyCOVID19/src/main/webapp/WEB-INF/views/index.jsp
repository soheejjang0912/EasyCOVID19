            ...
            <div class="row d_flex">
               ...
               <div class="col-md-5">
                  <div class="about_img text_align_center">
                     <figure><img src="<%=request.getContextPath()%>/resources/images/about.png" alt="#"/></figure>
                  </div>
               </div>
            ...
            <div class="row d_flex grid">
               <div class="col-md-7">
                  <div class="coronata_img text_align_center">
                     <figure><img src="<%=request.getContextPath()%>/resources/images/corona.png" alt="#"/></figure>
                  </div>
               </div>
                  ...
                  <div class="owl-carousel owl-theme">
                     <div class="item">
                        <div class="protect_box text_align_center">
                          <div class="desktop">
                             <i><img src="<%=request.getContextPath()%>/resources/images/pro1.png" alt="#"/></i>
                           <h3> Wear Mask</h3>
                     ...
                     <div class="item">
                          <div class="protect_box text_align_center">
                          <div class="desktop">
                             <i><img src="<%=request.getContextPath()%>/resources/images/pro2.png" alt="#"/></i>
                     ...
                     <div class="item">
                         <div class="protect_box text_align_center">
                          <div class="desktop">
                             <i><img src="<%=request.getContextPath()%>/resources/images/pro3.png" alt="#"/></i>
                           <h3> Stay at Home</h3>
                           <span> Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for</span>
                          </div>
                           <a class="read_more" href="protect.html">Read More</a>
               ...
               <div class=" col-md-6">
                     <div id="ho_efcet" class="reader text_align_center">
                        ...
                        <span><img src="<%=request.getContextPath()%>/resources/images/do.png" alt="#"/></span>
                          ...
                          <div class=" col-md-6">
                     <div id="ho_efcet" class="reader text_align_center">
                        <i><img src="<%=request.getContextPath()%>/resources/images/doctor2.png" alt="#"/></i>
                        <h3>Dr.Golap den</h3>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look</p>
                        <span><img src="<%=request.getContextPath()%>/resources/images/do.png" alt="#"/></span>
                     </div>
